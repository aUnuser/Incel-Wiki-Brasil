...
## Incelosfera
Existe um grupo de sites e fórums mais ou menos conectados onde o estado de ser uma falha romântica é discutido, mas nem todos usam terminologia incel ou se dizem "fórums incel". Os que visitam estes sites são chamados de [cybercels](). Essa rede de comunidades online onde incels se reúnem é às vezes chamada de [incelosfera]().
